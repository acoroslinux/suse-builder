...
class ToolchainManager:
    ...
    def _install_isolated_tools(self) -> None:
        ...
        packages = ["squashfs", "zstd", "xorriso", "grub2", "grub2-x86_64-efi", "grub2-i386-efi", "mtools", "dosfstools", "qemu-tools", "parted", "e2fsprogs", "btrfsprogs", "syslinux", "util-linux", "ca-certificates"]
